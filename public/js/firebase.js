 ...
 * on the Google OAuth client. mynote-tax.web.app URIs → redirect_uri_mismatch.
 */
 ...
 * third-party storage when authDomain ≠ mynote-tax.web.app — and switching
 * authDomain to mynote-tax.web.app causes redirect_uri_mismatch (handler URI
